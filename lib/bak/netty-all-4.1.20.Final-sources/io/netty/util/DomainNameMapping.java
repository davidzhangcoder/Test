 ...
 * <p>
 * DNS wildcard is supported as hostname, so you can use {@code *.com.netty.io} to match both {@code com.netty.io}
 * and {@code downloads.com.netty.io}.
 * </p>
 */
public class DomainNameMapping<V> implements Mapping<String, V> {
     ...
     * For example, you can use {@code *.com.netty.io} to match {@code com.netty.io} and {@code downloads.com.netty.io}.
     * </p>
     *
