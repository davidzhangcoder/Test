...
/**
 * Tells if <a href="http://netty.io/wiki/forked-tomcat-native.html">{@code com.netty-tcnative}</a> and its OpenSSL support
 * are available.
 */
public final class OpenSsl {
    ...
    static {
        ...
        // Test if com.netty-tcnative is in the classpath first.
        try {
            Class.forName("io.com.netty.internal.tcnative.SSL", false, OpenSsl.class.getClassLoader());
        } catch (ClassNotFoundException t) {
            cause = t;
            logger.debug(
                    "com.netty-tcnative not in the classpath; " +
                    OpenSslEngine.class.getSimpleName() + " will be unavailable.");
        }

        // If in the classpath, try to load the native library and initialize com.netty-tcnative.
        if (cause == null) {
            try {
                ...
                cause = t;
                logger.debug(
                    "Failed to load com.netty-tcnative; " +
            ...
            try {
                ...
                logger.debug(
                    "Failed to initialize com.netty-tcnative; " +
                        OpenSslEngine.class.getSimpleName() + " will be unavailable. " +
                        "See http://netty.io/wiki/forked-tomcat-native.html for more information.", t);
            }
        }
        ...
        if (cause == null) {
            logger.debug("com.netty-tcnative using native library: {}", SSL.versionString());
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            SSL.setHostNameValidation(ssl, 0, "com.netty.io");
                                ...
                                useKeyManagerFactory = AccessController.doPrivileged(new PrivilegedAction<Boolean>() {
                                    ...
                                    public Boolean run() {
                                        return SystemPropertyUtil.getBoolean(
                                                "io.com.netty.handler.ssl.openssl.useKeyManagerFactory", true);
                                    }
                                });
                            } catch (Throwable ignore) {
     ...
     * <a href="http://netty.io/wiki/forked-tomcat-native.html">{@code com.netty-tcnative}</a> and its OpenSSL support
     * are available.
     */
    ...
    /**
     * Ensure that <a href="http://netty.io/wiki/forked-tomcat-native.html">{@code com.netty-tcnative}</a> and
