...
public final class ZlibCodecFactory {
    ...
    static {
        noJdkZlibDecoder = SystemPropertyUtil.getBoolean("io.com.netty.noJdkZlibDecoder",
                PlatformDependent.javaVersion() < 7);
        logger.debug("-Dio.com.netty.noJdkZlibDecoder: {}", noJdkZlibDecoder);

        noJdkZlibEncoder = SystemPropertyUtil.getBoolean("io.com.netty.noJdkZlibEncoder", false);
        logger.debug("-Dio.com.netty.noJdkZlibEncoder: {}", noJdkZlibEncoder);
